  ...
  return (
    <section id="product" className={layout.sectionReverse}>
      ...
      <div className={layout.sectionInfo}>
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>Turpis egestas sed tempus urna et pharetra pharetra massa massa ultricies mi quis hendrerit dolor magna eget est lorem ipsum.</p>
